...
class TMouse {
  constructor(scene) {
    this.scene = scene;
    this.ground = this.scene.meshes.filter(
  ...
  createPointerDownObserver(func) {
    this.pointerDownObserver = this.scene.onPointerObservable.add(
      func,
  ...
  createPointerMoveObserver(func) {
    this.pointerMoveObserver = this.scene.onPointerObservable.add(
      func,
  ...
  createPointerUpObserver(func) {
    this.pointerUpObserver = this.scene.onPointerObservable.add(
      func,
