...
function addTexture(state, action){
	return state.set(Canvas.textures, state.get(Canvas.textures).set(action.value.name, action.value.src));
}
...
function addCustomObject(state, action){
	return state.set(Canvas.customObjects, state.get(Canvas.customObjects).set(action.object.name, action.object.src));
}
