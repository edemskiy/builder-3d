...
class TexturesControl extends Component {
  componentDidUpdate(prevProps) {
    ...
    if (
      ...
      if (currentObj.material.diffuseTexture) {
        this.refs.changeScale.value =
          1 / currentObj.getMesh().material.diffuseTexture.uScale;
  ...
  changeScale() {
    this.props.pickedObjects
      .last()
      .getObject()
      .scaleTexture(parseFloat(this.refs.changeScale.value));
  }
  ...
  changeOffsetX() {
    this.props.pickedObjects
      .last()
      .getObject()
      .offsetTextureX(parseFloat(this.refs.xOffset.value));
  }
  ...
  changeOffsetY() {
    this.props.pickedObjects
      .last()
      .getObject()
      .offsetTextureY(parseFloat(this.refs.yOffset.value));
  }
